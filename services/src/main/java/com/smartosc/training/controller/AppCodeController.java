...
public class AppCodeController {
    ...
    public ResponseEntity<Object> addAppCode(@RequestBody AppCodeDTO appCodeDTO) {
        appCodeDTO.setCreatedBy(SecurityContextHolder.getContext().getAuthentication().getName());
        appCodeDTO.setModifiedBy(SecurityContextHolder.getContext().getAuthentication().getName());
